...
const translations = {
  esp: {
    ...
    'proj.rizoma.tagline': 'App botánica · Expo',
    ...
    'proj.rizoma.desc': 'App móvil de boutique botánica: descubrir, comprar y cuidar plantas en un solo flujo local-first.',
    'proj.viewGithub': 'Ver en GitHub',
    'proj.viewCase': 'Ver proyecto',
  ...
  cat: {
    ...
    'proj.rizoma.tagline': 'App botànica · Expo',
    'proj.vigorly.tagline': 'App de fitness · Jetpack Compose',
    ...
    'proj.rizoma.desc': 'App mòbil de boutique botànica: descobrir, comprar i cuidar plantes en un sol flux local-first.',
    'proj.viewGithub': 'Veure a GitHub',
    'proj.viewCase': 'Veure projecte',
  ...
  eng: {
    ...
    'proj.rizoma.tagline': 'Botanical app · Expo',
    ...
    'proj.rizoma.desc': 'Mobile botanical boutique app: discover, buy and care for plants in one local-first flow.',
    'proj.viewGithub': 'View on GitHub',
    'proj.viewCase': 'View project',
